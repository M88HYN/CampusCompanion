    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-gradient-to-b from-sidebar via-sidebar to-sidebar-accent/20 text-sidebar-foreground w-[var(--sidebar-width)] p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-[var(--sidebar-width)] bg-transparent transition-[width] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)]",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] md:flex",
          side === "left"
      ...
      >
        <div
          ...
          className="bg-gradient-to-b from-sidebar via-sidebar to-sidebar-accent/15 group-data-[variant=floating]:border-sidebar-border/70 flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm shadow-[inset_0_1px_0_hsl(var(--sidebar-accent)/0.22)]"
        >
          {children}
        </div>
      </div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-6 -translate-x-1/2 transition-all duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] group-data-[side=left]:-right-5 group-data-[side=right]:left-1 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex",
