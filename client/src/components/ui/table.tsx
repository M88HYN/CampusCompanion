...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-xl border border-border/60 state-fade">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b surface-transition hover:bg-muted/40 hover:-translate-y-[1px] data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
